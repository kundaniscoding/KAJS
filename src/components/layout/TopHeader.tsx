  ...
  return (
    <header className="sticky top-0 z-20 grid grid-cols-12 h-16 items-center border-b border-slate-200 bg-white/90 px-6 backdrop-blur">
      ...
      <div className="col-span-4 md:col-span-3 flex flex-col justify-center min-w-0">
        ...
        {viewSubtitles[view] && (
          <p className="text-[10px] text-slate-500 mt-1.5 leading-none font-medium truncate">
            {viewSubtitles[view]}
          </p>
        )}
      </div>
      ...
      <div className="col-span-4 md:col-span-3 flex items-center justify-end gap-3 min-w-0">
        <TooltipProvider delayDuration={200}>
          ...
          <div className="hidden text-right text-xs leading-tight text-slate-500 sm:block mx-1 flex flex-col justify-center">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="outline"
                size="icon"
                className="relative rounded-full border-slate-200 hover:bg-slate-50 hover:text-indigo-600 h-9 w-9 shrink-0"
              >
