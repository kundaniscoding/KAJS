...
export function AttendanceLogModal({
  ...
  const logs = [
    { datetime: "Jul 20, 2026, 08:21", time: "02:36:02", type: "OUT", device: "MFP3241900342", status: "1" },
    { datetime: "Jul 20, 2026, 08:58", time: "03:13:17", type: "OUT", device: "MFP3241900342", status: "1" },
    { datetime: "Jul 20, 2026, 08:58", time: "03:13:20", type: "OUT", device: "MFP3241900342", status: "1" },
    { datetime: "Jul 20, 2026, 19:26", time: "13:41:47", type: "OUT", device: "MFP3243500184", status: "1" },
    { datetime: "Jul 20, 2026, 19:26", time: "13:41:49", type: "OUT", device: "MFP3243500184", status: "1" },
    { datetime: "Jul 20, 2026, 20:10", time: "14:25:35", type: "OUT", device: "MFP3243500184", status: "1" },
    { datetime: "Jul 20, 2026, 20:10", time: "14:25:53", type: "OUT", device: "MFP3243500184", status: "1" },
  ];
      ...
      <div className="relative w-full max-w-4xl overflow-hidden rounded-xl border border-slate-200 bg-white p-8 shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 mt-5">
            <Badge className="bg-slate-800 hover:bg-slate-800 text-white rounded text-xs px-2.5 py-0.5">Present</Badge>
            <Badge variant="outline" className="text-slate-700 border-slate-200 rounded text-xs px-2.5 py-0.5 font-medium bg-slate-50/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Planned Time</div>
            ...
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Actual Time</div>
            ...
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Worked Hours</div>
            ...
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Planned Hours</div>
            ...
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Late Minutes</div>
            ...
            <Card className="shadow-none border-slate-200 bg-[#fcfdfd]">
              <CardContent className="px-4 py-3">
                <div className="text-[10px] font-semibold tracking-wider text-slate-500 uppercase mb-1">Overtime Minutes</div>
                <div className="text-lg font-bold text-slate-800">0</div>
              </CardContent>
            </Card>
          </div>
